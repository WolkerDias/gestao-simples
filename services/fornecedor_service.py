...
class FornecedorService:
    ...
    def deletar_fornecedor(self, id):
        try:
            ...
            if self.repository.existe_relacionamento(NFCe.fornecedor_id, id):
                error_msg = f"Não é possível excluir o fornecedor {fornecedor.nome} (ID {id}) pois existe NFCe associada."
                logger.warning(error_msg)
