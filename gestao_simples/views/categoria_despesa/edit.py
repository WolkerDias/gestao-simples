# views/categoria_despesa/edit.py
...
def show_edit_categoria_despesa(categoria: CategoriaDespesa):
    """Exibe o formulário de edição de categoria de despesa"""
    if not categoria:
    ...
    st.header("✏️ Editar Categoria de Despesa")
    st.subheader(f"Editando: {categoria.nome}")
    
    with st.form("form_edit_categoria_despesa"):
        nome = st.text_input(
            "Nome*", 
