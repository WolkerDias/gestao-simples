...
PasswordLabel3=Por favor forneça a senha, então clique em Avançar para continuar. As senhas são caso-sensitivo.
...
DiskSpaceWarning=O instalador requer pelo menos %1 KBs de espaço livre para instalar mas o drive selecionado só tem %2 KBs disponíveis.%n%nVocê quer continuar de qualquer maneira?
